    ...
    const fetchItems = async () => {
      ...
      try {
        ...
        if (error instanceof Error) {
          ...
          setError(error.message);  // Set error message for the UI
        } else {
